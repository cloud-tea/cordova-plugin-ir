...
- (void) searchRemote:(CDVInvokedUrlCommand*)command;
- (void) downloadRemote:(CDVInvokedUrlCommand*)command;
- (void) sendIRCode:(CDVInvokedUrlCommand*)command;
- (void) getBrandList:(CDVInvokedUrlCommand*)command;
- (void) getApplianceList:(CDVInvokedUrlCommand*)command;
